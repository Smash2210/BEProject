  ...
  function check(){
    ...
    <script type="text/javascript">
      ...
      function displayData(){
        var url_data = "compute/association.php";
        $('#putData').empty();
        $.ajax({
          url: url_data,
          data: "",
            ...
            $(json).each(function(i,val){
              $.each(val,function(k,v){
                ...
                // document.write("key:"+k+" Confidence:"+v['Confidence']+" Lift:"+v['Lift']);
                  ...
                  // tr.push('</tr>');      
                  g.row.add([k,v['Confidence'],v['Lift']]).draw(false);
              });
      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li class="active"><a href="association_rules.php"> <i class="icon-grid"></i>Generate Association Rules</a></li>
